...
import { 
    ...
    TrendingUp, DollarSign, Receipt, X
} from 'lucide-react';
                ...
                {groups.map((group) => (
                    <div key={group._id} className="bg-slate-900 border border-slate-800 rounded-[2.5rem] p-8 shadow-2xl relative overflow-hidden group hover:border-blue-500/30 transition-all">
                        <button 
                            ...
                            className="absolute top-6 left-20 text-slate-700 hover:text-red-500 transition-all opacity-0 group-hover:opacity-100"
                        >
                            <Trash2 size={18} />
                        </button>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex gap-4 pt-4">
                                ...
                                <button className={`px-4 py-3 rounded-xl font-bold text-sm border ${group.isPaidOut ? 'bg-emerald-500/20 border-emerald-500/40 text-emerald-400' : 'bg-slate-800 border-slate-700 text-slate-500'}`}>
                    ...
                    <div className="bg-slate-900 border border-slate-800 w-full max-w-lg rounded-[2.5rem] p-8 shadow-2xl scale-in overflow-y-auto max-h-[90vh]">
                        ...
                        <form onSubmit={handleCreateGroup} className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <label className="text-xs text-slate-500 mr-2">تاريخ بداية الجمعية</label>
